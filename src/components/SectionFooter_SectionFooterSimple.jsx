...
export function SectionFooter_SectionFooterSimple() {
  ...
  return (
    <footer className="py-10 mt-auto" style={{ backgroundColor: '#F8FAFC' }} id="section_footer_simple" data-section-id="section_footer_simple" data-section-type="footer">
      <div className="max-w-7xl mx-auto px-6 flex flex-col gap-6">
        <div className="flex flex-col items-center gap-3"><img src="/images/logo-1.png" alt="" className="h-11 w-auto object-contain flex-shrink-0" /></div>
        ...
        <div className="flex flex-col items-center gap-3"><div dangerouslySetInnerHTML={{ __html: "<nav data-block-id=\"block_footer_links\" data-block-type=\"nav_links\" style=\"display:flex;flex-wrap:wrap;justify-content:center;gap:1rem\"><a href=\"#section_contact_form_contact\" style=\"color:var(--color-text);font-weight:500\">O projektu / kontakt</a><a href=\"#section_content_group_about_project_story\" style=\"color:var(--color-text);font-weight:500\">O Kláře</a><a href=\"#section_blog_feed\" style=\"color:var(--color-text);font-weight:500\">Trasa</a><a href=\"#section_contact_form_contact\" style=\"color:var(--color-text);font-weight:500\">Kontakt</a></nav>" }} /></div>
