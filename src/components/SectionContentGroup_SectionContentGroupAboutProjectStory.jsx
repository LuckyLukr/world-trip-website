  ...
  return (
    ...
    <section className="py-16 lg:py-20 jean-section-shell" style={{ backgroundColor: 'var(--color-bg-alt)' }}>
      <div className="max-w-5xl mx-auto px-6 flex flex-col gap-6">
        ...
        <div dangerouslySetInnerHTML={{ __html: "<div data-block-id=\"block_about_cta_secondary\" data-block-type=\"button\"><a href=\"#section_contact_form_contact\" style=\"display:inline-block;padding:.75rem 1.75rem;font-weight:600;border-radius:9999px;color:#fff;background:var(--color-primary);border:none\">Zjistit, jak vznikají deníky</a></div>" }} />
      </div>
    </section>
    </div>
  );
