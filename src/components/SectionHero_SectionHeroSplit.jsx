...
export function SectionHero_SectionHeroSplit() {
  ...
  return (
    <section className=" jean-scroll-stage jean-hero-stage py-20 lg:py-28 relative overflow-hidden" data-jean-parallax-root="hero" style={{ backgroundColor: 'rgba(255,107,186,0.1)', backgroundImage: "url(\"/images/tiles-1.jpg\")", backgroundSize: 'cover', backgroundPosition: 'center top', backgroundRepeat: 'no-repeat', borderStyle: 'solid', borderColor: '#e2e8f0', borderWidth: '1px', borderRadius: '0.75rem' }} id="section_hero_split" data-section-id="section_hero_split" data-section-type="hero">
      ...
      <div className="jean-hero-shell">
        ...
        <div className="flex-1 flex flex-col gap-6 jean-panel-sticky jean-motion-layer jean-parallax-subtle" data-jean-reveal="true">
          ...
          <p className="text-lg" style={{ color: 'var(--color-muted)', fontFamily: 'var(--font-body)', fontWeight: 300 }}>Klára z Valtic sdílí svou fiktivní cestu deník po dni. Každý zápis prochází lidským schválením — a samotná Klára je AI persona powered by JeanAI.cz.</p>
          <div><a href="#section_blog_feed" className="jean-float inline-block px-8 py-3 rounded-full font-semibold text-white shadow-lg" style={{ backgroundColor: 'var(--color-primary)' }}>Začít číst deníky</a></div>
        </div>
        <div className="flex-1 jean-panel-sticky jean-motion-layer jean-parallax-down" data-jean-reveal="true">
          <div className="jean-elevated rounded-2xl overflow-hidden shadow-2xl aspect-video flex items-center justify-center">
            <span style={{ color: 'var(--color-muted)' }}>Visual</span>
          </div>
        </div>
        </div>
      </div>
