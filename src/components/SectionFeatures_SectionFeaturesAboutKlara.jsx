    ...
    <section className="py-20 lg:py-28 jean-scroll-stage jean-section-shell" data-jean-parallax-root="features" style={{ backgroundColor: 'var(--color-bg-alt)' }}>
      <div className="max-w-7xl mx-auto px-6 ">
        ...
        <div className="jean-stagger-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-start">
          <div className="jean-card jean-float p-8 rounded-2xl jean-motion-layer jean-stagger-card jean-parallax-up" data-jean-reveal="true" data-block-id="block_klara_feature_1" data-block-type="card" style={{ transitionDelay: '0s' }}>
          ...
          <div className="jean-card jean-float p-8 rounded-2xl jean-motion-layer jean-stagger-card jean-parallax-down" data-jean-reveal="true" data-block-id="block_klara_feature_2" data-block-type="card" style={{ transitionDelay: '0.08s' }}>
          ...
          <div className="jean-card jean-float p-8 rounded-2xl jean-motion-layer jean-stagger-card jean-parallax-up" data-jean-reveal="true" data-block-id="block_klara_feature_3" data-block-type="card" style={{ transitionDelay: '0.16s' }}>
